...
/******************************************************************************
 * Compilation: javac TwoPhaseSimplex.java Execution: java Simplex Dependencies:
 * System.out.java
 *
 * Given an m-by-n matrix A, an m-length vector b, and an n-length vector c,
 * solve the LP { max cx : Ax <= b, x >= 0 }. Unlike Simplex.java, this version
 * does not assume b >= 0, so it needs to find a basic feasible solution in
 * Phase I.
 *
